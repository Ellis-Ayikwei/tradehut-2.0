                    ...
                    >
                        ...
                        <div className="relative bg-white/5 backdrop-blur-sm p-6 border-b border-white/10 sticky top-0 z-10">
                            ...
                            <div className="flex items-center gap-4 pr-12">
                                <div className="w-14 h-14 flex-shrink-0 bg-gradient-to-br from-brand-light to-brand-dark rounded-2xl flex items-center justify-center text-white">
                        ...
                        <div className="p-6 overflow-y-auto flex-grow space-y-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                >
                                    <div className="w-12 h-12 flex-shrink-0 flex items-center justify-center bg-gradient-to-br from-green-400 to-green-600 rounded-xl text-white group-hover:scale-105 transition-transform">
                                ...
                                >
                                    <div className="w-12 h-12 flex-shrink-0 flex items-center justify-center bg-gradient-to-br from-brand-light to-brand-dark rounded-xl text-white group-hover:scale-105 transition-transform">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-6 border-t border-white/10">
                                <div className="p-4 bg-white/5 border border-white/10 rounded-xl">
                                    <div className="flex items-center gap-4">
                                        <div className="w-11 h-11 flex-shrink-0 flex items-center justify-center bg-gradient-to-br from-slate-600 to-slate-800 rounded-xl text-white">
