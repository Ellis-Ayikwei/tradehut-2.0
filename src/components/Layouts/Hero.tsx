...
export default function Hero() {
    ...
    return (
      ...
      <div className="relative w-full max-w-xs sm:max-w-md md:max-w-2xl lg:max-w-3xl xl:max-w-4xl mx-auto mt-3 sm:mt-4 md:mt-6 lg:mt-8 px-1 sm:px-2 md:px-4 lg:px-0">
            ...
            <div className="absolute inset-0 bg-brand/20 rounded-3xl blur-3xl transform scale-110"></div>
            <div className="absolute inset-0 bg-brand/15 rounded-3xl blur-2xl transform scale-105"></div>
            <div className="absolute inset-0 bg-brand/10 rounded-3xl blur-xl"></div>
                        ...
                        {[
                            ...
                            <Link key={index} to={service.link} className="block">
                                <motion.div
                                    ...
                                    className="flex flex-col p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hover:bg-white/10 hover:border-brand/30 transition-all duration-300 group cursor-pointer h-full"
                                >
                                    <div className="text-white/60 group-hover:text-brand transition-colors mb-4">
                                        {service.icon}
                                    </div>
                                    <h3 className="text-xl font-bold text-white mb-2 group-hover:text-brand transition-colors">{service.title}</h3>
                                    <p className="text-sm text-gray-400 mb-4 flex-grow">{service.description}</p>
                                    <div className="text-xs text-brand font-medium">{service.stats}</div>
                                </motion.div>
                            </Link>
                        ))}
                    </div>
